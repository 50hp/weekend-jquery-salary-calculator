...
function calculateIndividualEmployeeBonus(employee) {
  ...
  staffBonus.totalBonus = Math.round(employee.annualSalary * staffBonus.bonusPercentage);
  console.log('total bonus ', staffBonus.totalBonus);

  staffBonus.totalCompensation = Math.round(employee.annualSalary / 1 + staffBonus.totalBonus);
...
function runBonus(employeesInput) {

  for (let employee of employeesInput) {
    console.log(calculateIndividualEmployeeBonus(employee));
  }

}

console.log(runBonus(employees));
